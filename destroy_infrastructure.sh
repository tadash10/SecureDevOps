#!/bin/bash
# Script to destroy infrastructure for SecureDevOps by Tadash10
...
function destroy_infrastructure() {
  ...
  # Check for errors
  if [[ $? -ne 0 ]]; then
    echo "An error occurred during Terraform destruction."
    exit 1
  fi
}
...
do
  clear
  echo "============================================"
  echo "SecureDevOps Infrastructure Destruction Script"
  echo "============================================"
...
# Disclaimer
echo "This script is provided as is and without warranty of any kind. Tadash10 is not responsible for any damages or liabilities
